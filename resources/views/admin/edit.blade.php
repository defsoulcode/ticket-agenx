...
@section('container')
    <div class="row my-3">
        <h3 class="my-2 mb-4">Edit Order Details</h3>
        <div class="ms-3 col-5">
            <form action="/admin/{{ $ticket->number }}/update" method="post">
                @csrf
                <div class="mb-1 row">
                    <label for="id" class="col-sm-4 col-form-label" name="id">No Ticket</label>
                    <div class="col-sm-8">
                        <input type="text" readonly class="form-control" id="id" value="{{ $ticket->id }}">
                    </div>
                </div>
                <div class="mb-1 row">
                    <label for="created_at" class="col-sm-4 col-form-label" name="created_at"> Order Date</label>
                    <div class="col-sm-8">
                ...
                <div class="mb-1 row">
                    <label for="nama" class="col-sm-4 col-form-label">Customer Name</label>
                    <div class="col-sm-8">
                ...
                <div class="mb-1 row">
                    <label for="ktp" class="col-sm-4 col-form-label">ID</label>
                    <div class="col-sm-8">
